...
public class Main {
    public static void main(String[] args) {
        Toys doll1 = new Toys(1, "Кукла Маша", 5, 50);
        Toys doll2 = new Toys(2, "Кукла Даша", 5, 30);
        Toys doll3 = new Toys(3, "Кукла Саша", 5, 20);
        Toys designer1 = new Toys(4, "Конструктор малый", 5, 50);
        Toys designer2 = new Toys(5, "Конструктор средний", 5, 30);
        Toys designer3 = new Toys(6, "Конструктор большой", 5, 20);
        Toys teddyBear1 = new Toys(7, "Медвежонок маленький", 5, 50);
        Toys teddyBear2 = new Toys(8, "Медвежонок средний", 5, 30);
        Toys teddyBear3 = new Toys(9, "Медвежонок большой", 5, 20);
